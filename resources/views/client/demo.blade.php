...
<body>
    <div style="position:relative;background-color: red;min-height: 150vh;width:auto">
        <div style="min-height: 130vh;">Yes</div>
        <div style="position:sticky;bottom:0">Đây là sticky</div>
    </div>
    {{-- <main>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12 col-12">
                        ...
                        <div style="position:relative;background-color: red;height:500px;width:auto">
                            <div style="position:sticky;bottom:0">Đây là sticky</div>
                        </div>
                    </div>
                </div>
