<div class="custom-block-bottom d-flex justify-content-end sono" style="color: #717275">
    <p class="bi-eye mb-0" style="margin-right:40px">&nbsp;{{ $sach->luot_xem }}</p>
    @if (Auth::check())
    ...
    @else
        <p class="bi-heart mb-0">&nbsp;{{ $sach->luot_thich }}</p>
    @endif
    <p class="bi-chat mb-0" style="margin-left:40px">&nbsp;{{ $sach->luot_binh_luan }}</p>
</div>
