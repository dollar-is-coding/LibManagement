...
<body>
    <main>
                        ...
                        <div class="custom-block d-flex">
                            <div>
                                <div class="custom-block-icon-wrap">
                                    ...
                                    <a href="{{ route('thong-tin-sach', ['id' => $item->id]) }}" class="custom-block-image-wrap">
                                        @if ($item->hinh_anh != '')
                                        <img src="../img/books/{{ $item->hinh_anh }}" class="custom-block-image img-fluid" />
                                        @else
                            ...
                            <div class="custom-block-info">
                                <div class="custom-block-top d-flex mb-1">
                                    ...
                                    <small class="me-4">Mã sách <span class="badge">#{{ $item->ma_sach }}</span></small>
                                    <small>Số lượng <span class="badge">{{ $item->hasThuVien->sl_con_lai }}</span></small>
                                </div>
                                <h5 class="mb-2">
                                    <a style="width:17em; display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; overflow: hidden;" href="{{ route('thong-tin-sach', ['id' => $item->id]) }}">
                                        {{ $item->ten }} </a>
                                </h5>
                                <div class="profile-block d-flex">
                                    ...
                                    <p>
                                        Tác giả
                                        <strong>
                                            <a href="{{ route('sach-theo-chu-de', ['dieu_kien' => 2, 'tac_gia' => $item->tac_gia_id]) }}" class="author">{{ $item->fkTacGia->ten }}</a>
                                        </strong>
                                    </p>
                                </div>
                    ...
                    <div class="col-lg-4 col-12 mx-auto">
                        <nav aria-label="Page navigation example">
                            <ul class="pagination pagination-lg justify-content-center mt-5">
                                <h4>
                                    <a href="{{ route('sach-theo-chu-de', ['dieu_kien' => 1]) }}" onMouseOver="this.style.textDecoration='underline'" onMouseOut="this.style.textDecoration='none'" href="">Xem tất
                                        cả</a>
                                </h4>
                            </ul>
                        </nav>
        ...
        <section class="topics-section section-padding {{ $xu_huong->count() > 0 ? 'pb-5' : '' }} {{ $sach_moi->count() > 0 ? 'pt-0' : '' }}" id="section_3">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-12">
                        <div class="section-title-wrap mb-5">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 {{ $key > 3 ? 'mt-3' : '' }}">
                        <div class="custom-block custom-block-overlay">
                            <a href="{{ route('sach-theo-chu-de', ['dieu_kien' => 3, 'the_loai' => $item->the_loai_id]) }}" class="custom-block-image-wrap">
                                @if ($item->the_loai_id == 1)
                                <img src="../img/default/bia_sach_giao_khoa.jpg" class="custom-block-image img-fluid" />
                                @endif
                                @if ($item->the_loai_id == 2)
                                <img src="../img/default/bia_tham_khao.jpg" class="custom-block-image img-fluid" />
                                @endif
                                @if ($item->the_loai_id == 3)
                                <img src="../img/default/bia_phat_trien.jpg" class="custom-block-image img-fluid" />
                                @endif
                                @if ($item->the_loai_id == 4)
                                <img src="../img/default/bia_tap_chi.jpg" class="custom-block-image img-fluid" />
                                @endif
                                @if ($item->the_loai_id == 5)
                                <img src="../img/default/bia_khoa_hoc.jpg" class="custom-block-image img-fluid" />
                                @endif
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-12 mb-4 mb-lg-0 {{ $key > 2 ? 'mt-4' : '' }}">
                        <div class="custom-block custom-block-full">
                            ...
                            <div class="custom-block-info">
                                <h5 class="mb-2">
                                    <a style="width:13em; display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; overflow: hidden;" href="{{ route('thong-tin-sach', ['id' => $item->fkSach->id]) }}">
                                        {{ $item->fkSach->ten }}</a>
                                </h5>
                                <div class="profile-block d-flex">
                                    <img src="../img/default/author.png" class="profile-block-image img-fluid" />
                                    <p>
                                        Tác giả
                                        <strong>
                                            <a href="{{ route('sach-theo-chu-de', ['dieu_kien' => 2, 'tac_gia' => $item->fkSach->tac_gia_id]) }}" class="author">{{ $item->fkSach->fkTacGia->ten }}</a>
                                        </strong>
                                    </p>
                                </div>
                    ...
                    <div class="col-lg-4 col-12 mx-auto">
                        <nav aria-label="Page navigation example">
                            <ul class="pagination pagination-lg justify-content-center mt-5">
                                <h4>
                                    <a href="{{ route('thang-nay-doc-gi') }}" onMouseOver="this.style.textDecoration='underline'" onMouseOut="this.style.textDecoration='none'" href="">
                                        Xem tất cả</a>
                                </h4>
                            </ul>
                        </nav>
