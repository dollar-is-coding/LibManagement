...
<body>
    <main>
        ...
        <section class="latest-podcast-section section-padding pt-2 {{ $key == $the_loai->count() - 1 ? '' : 'pb-5' }}" id="section_2">
            <div class="container">
                        ...
                        <div class="custom-block d-flex">
                            <div>
                                <div class="custom-block-icon-wrap">
                                    ...
                                    <a href="{{ route('thong-tin-sach', ['id' => $sach->id]) }}" class="custom-block-image-wrap">
                            ...
                            <div class="custom-block-info">
                                <div class="custom-block-top d-flex mb-1">
                                    ...
                                    <small class="me-4">Mã sách <span class="badge">#{{ $sach->ma_sach }}</span></small>
                                    <small>Số lượng <span class="badge">{{ $sach->hasThuVien->sl_con_lai }}</span></small>
                                </div>
                                <h5 class="mb-2">
                                    <a style="width:17em; display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; overflow: hidden;" href="{{ route('thong-tin-sach', ['id' => $sach->id]) }}">
                                        {{ $sach->ten }}</a>
                                </h5>
                                <div class="profile-block d-flex">
                                    <img src="../img/default/author.png" class="profile-block-image img-fluid" alt="" />
                                    <p>
                                        Tác giả
                                        <strong><a href="{{ route('sach-theo-chu-de', ['dieu_kien' => 2, 'tac_gia' => $sach->tac_gia_id]) }}" class="author">
                                                {{ $sach->fkTacGia->ten }}
                                            </a></strong>
                                    </p>
                                </div>
                    ...
                    <div class="col-lg-4 col-12 mx-auto">
                        <nav aria-label="Page navigation example">
                            <ul class="pagination pagination-lg justify-content-center mt-5">
                                <h4>
                                    <a href="{{ route('sach-theo-chu-de', ['dieu_kien' => 3, 'the_loai' => $item->id]) }}" onMouseOver="this.style.textDecoration='underline'" onMouseOut="this.style.textDecoration='none'" href="">
                                        Xem tất cả</a>
                                </h4>
                            </ul>
                        </nav>
