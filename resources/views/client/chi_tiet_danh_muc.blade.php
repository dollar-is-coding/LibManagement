            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-12 text-center">
                        <h2 class="mb-0">{{ $the_loai_id == 1 ? 'Sách giáo khoa' : '' }}</h2>
                        <h2 class="mb-0">{{ $the_loai_id == 2 ? 'Sách tham khảo' : '' }}</h2>
                        <h2 class="mb-0">{{ $the_loai_id == 3 ? 'Sách phát triển kỹ năng sống' : '' }}</h2>
                        <h2 class="mb-0">{{ $the_loai_id == 4 ? 'Báo, tạp chí' : '' }}</h2>
                        <h2 class="mb-0">{{ $the_loai_id == 5 ? 'Sách khoa học' : '' }}</h2>
                        <h2 class="mb-0">{{ $the_loai_id == 6 ? 'Sách văn học' : '' }}</h2>
                    </div>
                </div>
            </div>
        </header>
