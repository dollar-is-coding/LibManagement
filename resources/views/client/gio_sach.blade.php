...
<body>
    <main>
        ...
        <section class="latest-podcast-section section-padding pt-2" id="section_2">
            ...
            <div class="container">
                @if ($gio_sach->count() > 0)
                <form action="{{ route('muon-sach') }}" class="row justify-content-center" id="muon_sach" style="position: relative;" method="POST">
                    @csrf
                    <div style="font-family: 'Sono'">
                        <div class="d-flex justify-content-between shadow-sm border" style="padding:20px 30px 20px 30px; border-radius:30px">
                    ...
                    <div class="mt-4" style="font-family: 'sono'" id="sach_{{ $sach->sach_id }}">
                        <div class="custom-block">
                            <div class="d-flex align-items-center">
                                <input style="width:1em;height:1em" type="checkbox" class="checkbox" name="{{ $sach->sach_id }}">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="d-flex" style="width:55%">
                                    <div class="custom-block-icon-wrap">
                                        ...
                                        <a class="custom-block-image-wrap">
                                            ...
                                            <img src="../img/books/{{ $sach->fkSach->hinh_anh }}" class="custom-block-image img-fluid" alt="" />
                                            @else
                                ...
                                <div class="d-flex flex-column justify-content-evenly align-items-center" style="width:15%">
                                    <div>
                                        <a onclick="removeGioSach({{ $sach->sach_id }})" class="btn danger-btn">Bỏ chọn</a>
                                    </div>
                                    <div>
                                        <a href="{{ route('thong-tin-sach', ['id' => $sach->sach_id]) }}" class="btn custom-btn">Xem thông tin</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-5 d-flex" style="font-family:'Sono'; position: sticky; bottom: 0;">
                        <div class="d-flex justify-content-end border flex-grow-1 bg-white shadow" style="padding:20px 30px 20px 30px; border-radius:30px">
                        ...
                        <div class="d-inline-flex justify-content-center">
                            <button id="gio-sach-btn" style="pointer-events: none" type="submit" class="shadow pagination pagination-lg btn custom-btn">
                                Vui lòng chọn sách
                            </button>
                        </div>
                        <div class="m-1"></div>
