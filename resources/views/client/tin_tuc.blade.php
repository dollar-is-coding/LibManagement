...
<body>
    <main>
        ...
        @if ($noi_bat)
        <section class="about-section section-padding pt-2 {{ $tin_tuc->count() > 0 ? 'pb-0' : '' }}" id="section_2">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-12 mx-auto">
                        <div class="pb-5">
                            ...
                            @if ($noi_bat->anh_bia)
                            <div class="d-flex justify-content-center">
                                <img src="../img/news/{{ $noi_bat->anh_bia }}" class="about-image mt-3 img-fluid" />
                            </div>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="custom-block custom-block-full">
                            <div class="custom-block-image-wrap">
                                <a href="{{ route('tin-tuc', ['tin_tuc' => $item->id]) }}">
                                    @if ($item->anh_bia != '')
                                    <img src="../img/news/{{ $item->anh_bia }}" class="custom-block-image img-fluid" alt="" />
                                    @else
                            ...
                            <div class="custom-block-info">
                                <h5 class="mb-2">
                                    <a style="width:13em; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden;" href="{{ route('tin-tuc', ['tin_tuc' => $item->id]) }}">{{ $item->ten }}</a>
                                </h5>
                                <hr class="m-0 mb-2">
