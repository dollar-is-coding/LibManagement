...
<body>
                            ...
                            <div style="display: flex;flex-direction: row-reverse;	">
                                ...
                                <div style="flex-basis: 70%">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required name="the_loai" class="form-control select3-no-search"
                                            tabindex="3">
                                            <option label="Choose one"></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required name="nha_xuat_ban" class="form-control select4-no-search"
                                            tabindex="4">
                                            <option label="Choose one"></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required id="tuSachSelect" name="tu_sach"
                                            class="form-control select5-no-search" tabindex="6">
                                ...
                                <div class="upload-container row" style="flex-basis: 30%; margin-right: 2%">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required name="khu_vuc" class="form-control select6-no-search"
                                            tabindex="8">
                                            <option label="Choose one"></option>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.select4-no-search').select2({
                minimumResultsForSearch: Infinity,
                placeholder: 'Chọn nhà xuất bản'
            });
            $('.select5-no-search').select2({
                minimumResultsForSearch: Infinity,
                placeholder: 'Chọn tủ sách'
            });
            $('.select6-no-search').select2({
                minimumResultsForSearch: Infinity,
