                    ...
                    <div class="table-responsive">
                        ...
                        <div class="container border rounded pt-3 pl-4 pr-3 pb-2 mb-2" style="display: grid;grid-template-columns: auto;">
                            <div class="d-flex">
                                ...
                                <div class="ml-3">
                                    @php
                                    $hanTra = strtotime($item->han_tra);
                                    $ngayHienTai = strtotime(date('Y-m-d'));

                                    $hanTra = new DateTime($item->han_tra);
                                    $ngayHienTai = new DateTime();
                                    $diff = $ngayHienTai->diff($hanTra);
                                    $soNgay = $diff->days +1;
                                    if ($hanTra < $ngayHienTai) { echo "Đã trễ hạn: <b>$soNgay Ngày </b>" ; } else { echo "Số ngày còn lại: <b>$soNgay Ngày </b>" ; } @endphp </div>
                                </div>
                                <div>
                                    @php
                                    if ($hanTra < $ngayHienTai) { echo '<p style="color:red;font-size:20px"><b>Hết hạn</b></p>' ; } else { echo '<p style="color:green;font-size:20px"><b>Còn hạn</b></p>' ; } @endphp </div>
                                        ...
                                        <div class="ml-2" style="display: grid;grid-template-columns: auto auto">
                                            ...
                                            <div style="display: flex;flex-direction: row-reverse;">
                                                <a href="{{ route('thanh-toan-sach', ['id' => $item->ma_phieu_muon]) }}" class="btn btn-success rounded m-1">Trả sách</a>
