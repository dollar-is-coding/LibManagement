                ...
                <div class="table-responsive" style="display: grid;grid-template-columns: auto auto auto auto auto;">
                    @foreach ($sach as $item)
                        <div class="card" style="margin: 10px;width: 208px;">
                            @if ($item->hinh_anh == '')
                                <img style="width: 207px !important;height: 250px !important;"
                                    src="../img/default/no_book_admin.png" class="card-img-top">
                            @elseif($item->hinh_anh != '')
                                <img style="width: 207px !important;height: 250px !important;"
                                    src="/img/books/{{ $item->hinh_anh }}" class="card-img-top">
                            @endif
                            <div class="card-body">
                                <h5 style="width:10em; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden;"
                                    class="card-title">{{ $item->ten }}</h5>
